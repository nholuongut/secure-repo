...
func TestSecureWorkflow(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://api.github.com/repos/nholuongut/nholuongut-runner/commits/v2",
		httpmock.NewStringResponder(200, `ebacdc22ef6c2cfb85ee5ded8f2e640f4c776dd5`))

	httpmock.RegisterResponder("GET", "https://api.github.com/repos/nholuongut/nholuongut-runner/git/matching-refs/tags/v2.",
		httpmock.NewStringResponder(200,
			`[
				{
				  "ref": "refs/tags/v2.0.0",
				  "node_id": "REF_kwDOGSuXyrByZWZzL3RhZ3MvdjIuMC4w",
				  "url": "https://api.github.com/repos/nholuongut/nholuongut-runner/git/refs/tags/v2.0.0",
				  "object": {
					"sha": "ebacdc22ef6c2cfb85ee5ded8f2e640f4c776dd5",
					"type": "commit",
					"url": "https://api.github.com/repos/nholuongut/nholuongut-runner/git/commits/ebacdc22ef6c2cfb85ee5ded8f2e640f4c776dd5"
				  }
				}
			  ]`),
	)
	...
	tests := []struct {
		...
		wantAddednholuongutRunner bool
		wantAddedPermissions  bool
	}{
		{fileName: "allscenarios.yml", wantPinnedActions: true, wantAddednholuongutRunner: true, wantAddedPermissions: true},
		{fileName: "missingaction.yml", wantPinnedActions: true, wantAddednholuongutRunner: true, wantAddedPermissions: false},
		{fileName: "nonholuongutrunner.yml", wantPinnedActions: true, wantAddednholuongutRunner: false, wantAddedPermissions: true},
		{fileName: "noperms.yml", wantPinnedActions: true, wantAddednholuongutRunner: true, wantAddedPermissions: false},
		{fileName: "nopin.yml", wantPinnedActions: false, wantAddednholuongutRunner: true, wantAddedPermissions: true},
		{fileName: "allperms.yml", wantPinnedActions: false, wantAddednholuongutRunner: false, wantAddedPermissions: true},
		{fileName: "multiplejobperms.yml", wantPinnedActions: false, wantAddednholuongutRunner: false, wantAddedPermissions: true},
		{fileName: "error.yml", wantPinnedActions: false, wantAddednholuongutRunner: false, wantAddedPermissions: false},
	}
	for _, test := range tests {
		...
		case "nonholuongutrunner.yml":
			queryParams["addnholuongutRunner"] = "false"
		case "noperms.yml":
		...
		if output.AddednholuongutRunner != test.wantAddednholuongutRunner {
			t.Errorf("test failed %s did not match expected AddednholuongutRunner value. Expected:%v Actual:%v", test.fileName, test.wantAddednholuongutRunner, output.AddednholuongutRunner)
		}
